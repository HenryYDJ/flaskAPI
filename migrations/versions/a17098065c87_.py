...
Revision ID: a17098065c87
Revises: 
Create Date: 2021-05-11 00:01:54.412633
...
def upgrade():
    ...
    sa.Column('attendance_teacher', sa.INTEGER(), nullable=True),
    sa.Column('attendance_time', sa.DATETIME(), nullable=True),
    sa.ForeignKeyConstraint(['attendance_teacher'], ['users.id'], ),
